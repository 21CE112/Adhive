...
import {Verify} from 'dan-components';
import ResetPasswordInput from '../../components/Mycomponents/ResetPasswordInput';
function App(props) {
  const { history } = props;
  return (
    <ThemeWrapper>
      <Router history={history}>
        <Switch>
          ...
          <Route path="/resetPass" component={ResetPasswordInput} />
