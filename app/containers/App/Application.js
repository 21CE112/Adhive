...
import Booking1 from '../../components/Forms/Booking1';
import {
...
import AdDisplay from '../../components/Mycomponents/AdDisplay';
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        <Route path="/app/components/Forms/Booking" component={Booking} /> 
         <Route path="/app/components/Forms/Booking1" component={Booking1} /> 
        { /* Layout */ }
        <Route exact path="/app/layouts" component={Parent} />
        <Route path="/app/layouts/addisplay" component={AdDisplay} />
        <Route path="/app/layouts/booking1" component={Booking1} />
