  ...
  return (
    <footer className={classes.footer}>
      ...
      <div className={classes.copyright}>
        <div className={classes.container}>
          <p>&copy; 2023 srashtasoft. All Right Reserved </p>
          <span>
          ...
          {/* <IconButton color="primary" className={classes.button} href={link.pinterest} target="_blank"><i className="ion-logo-pinterest" /></IconButton> */}
            <IconButton color="primary" className={classes.button} href={link.github} target="_blank"><i className="ion-logo-instagram" /></IconButton>
            <IconButton color="primary" className={classes.button} href={link.github} target="_blank"><i className="ion-logo-facebook" /></IconButton>
          </span>
        </div>
      </div>
    </footer>
