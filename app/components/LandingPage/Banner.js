  ...
  return (
    ...
    >
      ...
      <div className={!slideMode ? classes.container : ''}>
        <Typography component="h2" variant="h2" gutterBottom>AdHive</Typography>
        <Typography component="p" variant="h5" gutterBottom>Be seen and remembered on the big screen</Typography>
        ...
        <div className={classes.previewApp}>
          <Hidden smDown>
            <div className={classNames(classes.m2, classes.screen, slideMode ? classes.bottom : '')}>
              <img src="/images/screen/personal2.png" alt="crm dashboard" />
            </div>
          </Hidden>
          ...
          <Hidden smDown>
            <div className={classNames(classes.m3, classes.screen, slideMode ? classes.bottom : '')}>
              <img src="/images/screen/personal2.png" alt="crypto dashboard" />
            </div>
          </Hidden>
